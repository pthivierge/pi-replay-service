...
[assembly: XmlConfigurator(ConfigFile = "PIReplayUI.log4net.cfg.xml", Watch = true)]
...
[assembly: AssemblyTitle("PI Data Replayer - Inserts oldest values into snapshot Service Manager User Interface")]

//Short description of the assembly

[assembly:
    AssemblyDescription(
        "PI Data Replayer - Inserts oldest values into snapshot Service Manager.  This is a user interface help starting or stopping the Service and manage service settings."
        )]
